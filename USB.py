...
def open_project_info():
    ...
    html_file_path = 'D:/Supraja Technologies/Tasks/Project/project_info.html'
...
def button1_clicked():
    ...
    def ok_button():
        if password_entry.get() == password:
            subprocess.run([r'D:/Supraja Technologies/Tasks/Project/block_usb.bat'], shell=True)
...
def button2_clicked():
    ...
    def ok_button():
        if password_entry.get() == password:
            subprocess.run([r'D:/Supraja Technologies/Tasks/Project/unblock_usb.bat'], shell=True)
            password_window.destroy()
...
background_image_path = "D:/Supraja Technologies/Tasks/Project/wallpaper.png"
